...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('🤖 Falcon Interview Judge started with:', { domain, interviewType });

    // Create sophisticated prompt for Falcon model
...
**RESPONSE FORMAT** (JSON only):
{
  ...
  "confidence": 92,
  "modelVersion": "falcon-7b-instruct-v1.0"
}
...
Provide your analysis now:`;
    ...
    // Use Falcon 7B model with advanced prompt engineering
    ...
    console.log('✅ Falcon judging completed successfully');
